...
static PyObject *__pyx_f_6bzrlib_12_readdir_pyx_5_Stat___repr__(PyObject *__pyx_v_self) {
  ...
  __pyx_8 = PyObject_GetAttr(__pyx_v_self, __pyx_n_st_mtime); if (!__pyx_8) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 158; goto __pyx_L1;}
  __pyx_9 = PyObject_GetAttr(__pyx_v_self, __pyx_n_st_ctime); if (!__pyx_9) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 158; goto __pyx_L1;}
...
static PyObject *__pyx_f_6bzrlib_12_readdir_pyx__read_dir(PyObject *__pyx_v_path) {
  ...
  if (__pyx_1) {
    ...
    if (__pyx_1) {
      ...
      __pyx_4 = 0;
      __pyx_2 = 0;
      __pyx_4 = PyObject_CallObject(PyExc_OSError, __pyx_3); if (!__pyx_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 303; goto __pyx_L1;}
      Py_DECREF(__pyx_3); __pyx_3 = 0;
      __Pyx_Raise(__pyx_4, 0, 0);
      Py_DECREF(__pyx_4); __pyx_4 = 0;
  ...
  /*try:*/ {
    ...
    if (__pyx_1) {
      ...
      __pyx_2 = 0;
      __pyx_4 = 0;
      __pyx_2 = PyObject_CallObject(PyExc_OSError, __pyx_3); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 310; goto __pyx_L6;}
      Py_DECREF(__pyx_3); __pyx_3 = 0;
      __Pyx_Raise(__pyx_2, 0, 0);
      Py_DECREF(__pyx_2); __pyx_2 = 0;
      ...
      while (1) {
        ...
        if (__pyx_1) {
          ...
          /*else*/ {
            ...
            __pyx_3 = 0;
            __pyx_4 = 0;
            __pyx_3 = PyObject_CallObject(PyExc_OSError, __pyx_2); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 333; goto __pyx_L10;}
            Py_DECREF(__pyx_2); __pyx_2 = 0;
        ...
        if (__pyx_6) {
          ...
          if (__pyx_1) {
            ...
            if (__pyx_6) {
              ...
              __pyx_3 = PyTuple_New(3); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 343; goto __pyx_L10;}
              PyTuple_SET_ITEM(__pyx_3, 0, __pyx_2);
              PyTuple_SET_ITEM(__pyx_3, 1, __pyx_4);
              ...
              __pyx_4 = 0;
              __pyx_8 = 0;
              __pyx_7 = PyObject_CallObject(PyExc_OSError, __pyx_3); if (!__pyx_7) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 343; goto __pyx_L10;}
              Py_DECREF(__pyx_3); __pyx_3 = 0;
