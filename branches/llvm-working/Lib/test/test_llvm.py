...
declare private %__pyobject @foo(%__pyobject, %__pyobject, %__pyobject, %__pyobject)
""")
...
declare private %__pyobject @"<module>"(%__pyobject, %__pyobject, %__pyobject, %__pyobject)
